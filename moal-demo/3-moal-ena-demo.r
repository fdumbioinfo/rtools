...
??moal::ena
# output directory
if(!file.exists("3-ena-outputdata")){"3-ena-outputdata" %>% dir.create}
# loading data
...
#
moal::ena(omicdata=omicdata$Symbol,species="hs",dirname="T21vsControl_243",path="3-ena-outputdata")
#
...
dat %>% head
moal::ena(omicdata=omicdata,dat=dat,factor=factor,species="hs",dirname="heatmaps_T21vsControl_243",path="3-ena-outputdata")
#
...
moal::ena(omicdata=omicdata,dat=dat,factor=factor,gmtfiles=gmtfiles,species="hs",dirname="gmtfiles_T21vsControl_243",path="3-ena-outputdata")
#
# -----
...
#
moal::ena(omicdata=omicdata,dat=dat,factor=factor,species="hs",dirname="GSEA_T21vsControl_23786",path="3-ena-outputdata")
#